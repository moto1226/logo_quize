  ...
  return [...groups.values()]
    ...
    .map((group) => ({
      ...
      brands: group.map((entry) => ({
        ...
        image: `../dist/logos/v20260618/${entry.brand_id}.webp`
      }))
    }))
...
<body>
  ...
  <section>
    ...
    ${risky.length ? `<div class="grid">${risky.map((entry) => `<article class="card">
      <img src="../dist/logos/v20260618/${htmlEscape(entry.brand_id)}.webp" loading="lazy" alt="${htmlEscape(entry.display_name)}">
